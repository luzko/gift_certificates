...
public class TagDAOImpl implements TagDAO {
    ...
    @Autowired
    public TagDAOImpl(MapSqlParameterSourceCreator parameterCreator, TagRowMapper rowMapper, JdbcTemplate jdbcTemplate) {
        this.parameterCreator = parameterCreator;
        this.rowMapper = rowMapper;
        this.jdbcTemplate = jdbcTemplate;
        this.insertTag = new SimpleJdbcInsert(jdbcTemplate)
                .withTableName(ColumnName.TAG.getValue()).usingGeneratedKeyColumns(ColumnName.TAG_ID.getValue());
    }
