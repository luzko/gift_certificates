...
ALTER TABLE gift_certificate_tag ALTER COLUMN gift_certificate_tag_id RESTART WITH 1;
ALTER TABLE gift_certificate ALTER COLUMN gift_certificate_id RESTART WITH 1;
ALTER TABLE tag ALTER COLUMN tag_id RESTART WITH 1;
