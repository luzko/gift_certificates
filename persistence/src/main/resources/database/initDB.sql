...
(
    gift_certificate_id   INT UNSIGNED AUTO_INCREMENT,
...
(
    gift_certificate_tag_id INT UNSIGNED AUTO_INCREMENT,
    gift_certificate_id_fk  INT UNSIGNED NOT NULL,
    tag_id_fk               INT UNSIGNED NOT NULL,
    PRIMARY KEY (gift_certificate_tag_id),
    UNIQUE KEY  (gift_certificate_id_fk, tag_id_fk),
